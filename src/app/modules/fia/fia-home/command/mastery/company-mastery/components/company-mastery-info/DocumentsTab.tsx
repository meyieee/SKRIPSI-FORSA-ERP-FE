...
const typeLabel: Record<NonNullable<CompanyDocument['fileType']>, string> = {
  pdf: 'PDF',
  word: 'Word',
  excel: 'Excel',
  image: 'Image',
...
const DocumentCard: React.FC<{doc: CompanyDocument}> = ({doc}) => {
  return (
...
const DocumentsTab: React.FC<Props> = ({company, documents}) => {
