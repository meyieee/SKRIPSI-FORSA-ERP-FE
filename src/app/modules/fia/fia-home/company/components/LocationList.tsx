    ...
    <KTCard className='h-100'>
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>LOCATION</span>
        </h3>
      </div>
                ...
                <tr key={location.id}>
                  ...
                  <td>
                    <div className='d-flex flex-column'>
                      <span className='fw-semibold fs-6 text-gray-800'>{location.name}</span>
                      <span className='text-muted fs-7'>{location.type}</span>
                    </div>
                  </td>
