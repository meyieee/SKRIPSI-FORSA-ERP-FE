...
import { TrainingRequestInfo } from '../../../../core/training-request'
  ...
  return (
    <FormSection title='Request Information'>
      ...
      <div className='row'>
        <div className='col-md-4'>
          <FormField
            label='Request By Job Title'
            name='requestInfo.requestByJobTitle'
            value={values.requestByJobTitle}
            onChange={(value) => setFieldValue('requestInfo.requestByJobTitle', value)}
            placeholder='[job title]'
          />
        </div>
        <div className='col-md-4'>
          <FormField
            label='Request For Job Title'
            name='requestInfo.requestForJobTitle'
            value={values.requestForJobTitle}
            onChange={(value) => setFieldValue('requestInfo.requestForJobTitle', value)}
            placeholder='[job title]'
          />
        </div>
      </div>
