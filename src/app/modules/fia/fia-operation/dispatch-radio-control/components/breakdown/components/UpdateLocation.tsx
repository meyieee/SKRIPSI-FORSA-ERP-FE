              ...
              <div className='row g-3'>
                ...
                <div className='col-12'>
                  <div className='d-flex align-items-center gap-3'>
                    <label className='form-label min-w-100px'>Date | Time :</label>
                ...
                <div className='col-12'>
                  <div className='d-flex align-items-center gap-3'>
                    <label className='form-label min-w-100px'>New Location :</label>
                    <input
                      type='text'
                      className='form-control'
                ...
                <div className='col-12'>
                  <div className='d-flex align-items-center gap-3'>
                    <label className='form-label min-w-100px'>Reason :</label>
                    <input
                      type='text'
                      className='form-control'
