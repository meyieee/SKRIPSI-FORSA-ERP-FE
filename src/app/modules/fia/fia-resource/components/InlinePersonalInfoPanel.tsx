// RecapInlinePersonalInfoPanel.tsx
...
/* Imports sub-tab sama seperti panel mastery temanmu */
import {
  PersonalDataTab,
  JobInfoTab,
  JobServiceTab,
...
// sama persis dengan InlinePersonalInfoPanel temanmu
...
const RecapInlinePersonalInfoPanel: React.FC = () => {
  ...
  return (
    <div className='mt-6'>
      {/* Header dari modul Personal Info */}
...
export default RecapInlinePersonalInfoPanel
